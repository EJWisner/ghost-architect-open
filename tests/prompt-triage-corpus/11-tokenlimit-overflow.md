<!--
  Fixture 11-tokenlimit-overflow.md
  Target word count: ~4032 words (128 numbered guideline lines)
  Severity tier: HIGH
  Generated: 2026-06-17 by _generate-length-fixtures.mjs

  Expected triage finding: tokenLimit/contextOverflow at HIGH severity.
  This is an intentionally bloated prompt, a long and repetitive
  instruction list whose overflows the test-tiny-4k 4,000-token window at roughly 111%.
