<!--
  Fixture 09-tokenlimit-approaching.md
  Target word count: ~2740 words (87 numbered guideline lines)
  Severity tier: LOW
  Generated: 2026-06-17 by _generate-length-fixtures.mjs

  Expected triage finding: tokenLimit/excessive at LOW severity.
  This is an intentionally bloated prompt, a long and repetitive
  instruction list whose sits at roughly 75% of the test-tiny-4k 4,000-token window.
