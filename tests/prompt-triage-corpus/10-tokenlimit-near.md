<!--
  Fixture 10-tokenlimit-near.md
  Target word count: ~3462 words (110 numbered guideline lines)
  Severity tier: MEDIUM
  Generated: 2026-06-17 by _generate-length-fixtures.mjs

  Expected triage finding: tokenLimit/excessive at MEDIUM severity.
  This is an intentionally bloated prompt, a long and repetitive
  instruction list whose sits at roughly 95% of the test-tiny-4k 4,000-token window.
